                        ...
                        <div className="d-flex justify-content-between col-4 d-none d-xl-flex">
                            <div className='nav-item dropdown'>
                                ...
                                <div className={`dropdown-menu drop_${mode}`} aria-labelledby="Dropdown">
                                    <Link className="dropdown-item" to={'/deadlockchatbox'}>Deadlock Chatbox</Link>
                                    <hr class="dropdown-divider"></hr>
                                    <Link className="dropdown-item" to={'/passguard'}>Pass Guard</Link>
                                    <hr class="dropdown-divider"></hr>
                                    <Link className="dropdown-item" to={'/hisabbook'}>Hisab Book</Link>
                                </div>
                            </div>
        ...
        <div className="position-sticky">
            <div className="list-group list-group-flush mx-3 ">
                ...
                <div className='list-group-item list-group-item-action py-3 ripple'>
                    ...
                    <div className={`dropdown-menu drop_${mode}`} aria-labelledby="Dropdown">
                        <Link to={'/deadlockchatbox'} className="dropdown-item" href={() => {}}>
                        Deadlock Chatbox
                        </Link>
                        <Link to={'/passguard'} className="dropdown-item" href={() => {}}>
                            Pass Guard
                        </Link>
                        <Link to={'/hisabbook'} className="dropdown-item" href={() => {}}>
                        Hisab Book
                        </Link>
                    </div>
                </div>
